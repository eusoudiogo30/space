...
// Placeholder shell only — mirrors the site's modal chrome (backdrop + card) so the "Sacar"
// button has somewhere real to land. The actual withdrawal flow (amount, PIX key, etc.) still
// needs to be built inside this card.
